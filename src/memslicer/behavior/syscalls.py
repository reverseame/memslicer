"""Linux syscall number -> name tables, per architecture.

Syscall numbers differ by architecture (and ABI), so each arch has its own
table. x86-64 is complete through the modern range; the others carry the common
subset. Unknown numbers fall back to ``sys_<nr>``. (Windows syscall numbers are
unstable across builds and are not tabulated -- Windows behavior is recovered
through API/export resolution instead.)
"""
...
# Linux i386 (arch/x86/entry/syscalls/syscall_32.tbl); common subset.
LINUX_X86 = {
    1: "exit", 2: "fork", 3: "read", 4: "write", 5: "open", 6: "close",
    7: "waitpid", 8: "creat", 9: "link", 10: "unlink", 11: "execve",
    12: "chdir", 13: "time", 14: "mknod", 15: "chmod", 19: "lseek",
    20: "getpid", 33: "access", 37: "kill", 39: "mkdir", 40: "rmdir",
    41: "dup", 42: "pipe", 45: "brk", 54: "ioctl", 55: "fcntl",
    63: "dup2", 78: "gettimeofday", 85: "readlink", 90: "mmap",
    91: "munmap", 102: "socketcall", 119: "sigreturn", 120: "clone",
    122: "uname", 125: "mprotect", 140: "_llseek", 141: "getdents",
    146: "writev", 162: "nanosleep", 168: "poll", 174: "rt_sigaction",
    175: "rt_sigprocmask", 192: "mmap2", 195: "stat64", 197: "fstat64",
    199: "getuid32", 221: "fcntl64", 224: "gettid", 240: "futex",
    252: "exit_group", 295: "openat", 355: "getrandom", 359: "socket",
    362: "connect", 380: "execveat",
}

# Linux generic / AArch64 (include/uapi/asm-generic/unistd.h); common subset.
LINUX_AARCH64 = {
    17: "getcwd", 19: "eventfd2", 23: "dup", 24: "dup3", 25: "fcntl",
    29: "ioctl", 32: "flock", 34: "mkdirat", 35: "unlinkat", 37: "linkat",
    38: "renameat", 48: "faccessat", 49: "chdir", 56: "openat", 57: "close",
    59: "pipe2", 61: "getdents64", 62: "lseek", 63: "read", 64: "write",
    65: "readv", 66: "writev", 73: "ppoll", 78: "readlinkat",
    79: "newfstatat", 80: "fstat", 93: "exit", 94: "exit_group",
    98: "futex", 101: "nanosleep", 124: "sched_yield", 129: "kill",
    131: "tgkill", 134: "rt_sigaction", 135: "rt_sigprocmask",
    139: "rt_sigreturn", 153: "times", 160: "uname", 165: "getrusage",
    167: "prctl", 172: "getpid", 173: "getppid", 174: "getuid",
    175: "geteuid", 176: "getgid", 177: "getegid", 178: "gettid",
    179: "sysinfo", 198: "socket", 200: "bind", 201: "listen",
    202: "accept", 203: "connect", 206: "sendto", 207: "recvfrom",
    208: "setsockopt", 211: "sendmsg", 212: "recvmsg", 214: "brk",
...
# Linux ARM EABI (arch/arm/tools/syscall.tbl); common subset (raw numbers,
# without the 0x900000 OABI base).
LINUX_ARM = {
    1: "exit", 2: "fork", 3: "read", 4: "write", 5: "open", 6: "close",
    11: "execve", 45: "brk", 54: "ioctl", 63: "dup2", 78: "gettimeofday",
    90: "mmap", 91: "munmap", 120: "clone", 122: "uname", 125: "mprotect",
    192: "mmap2", 195: "stat64", 197: "fstat64", 240: "futex",
    248: "exit_group", 281: "socket", 283: "connect", 322: "openat",
    384: "getrandom",
}

_TABLES = {
    ArchType.x86_64: LINUX_X86_64,
    ArchType.x86: LINUX_X86,
    ArchType.ARM64: LINUX_AARCH64,
    ArchType.ARM32: LINUX_ARM,
}


def syscall_name(arch: ArchType, nr: int) -> str:
    """Return the syscall name for *nr* on *arch*, or ``sys_<nr>`` if unknown."""
    return _TABLES.get(arch, {}).get(nr, f"sys_{nr}")
